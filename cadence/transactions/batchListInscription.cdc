...
transaction(listingModels: [ListingUtils.ListingModel]) {
    ...
    execute {
        ...
        for listingModel in listingModels {
            // Remove old listing
            if let listingID = Marketplace.getListingID(nftType: Type<@Inscription.NFT>(), nftID: listingModel.saleNFTID) {
            ...
            var remainingPrice = listingModel.saleItemPrice
            for requirement in requirements {
                let price = listingModel.saleItemPrice * requirement.ratio
