...
pub fun main(address: Address, id: UInt64): Inscription {
    ...
    let nft = collection.borrowInscription(id: id)!

    // Get the basic display information for this Inscription
    let display = MetadataViews.getDisplay(nft)!

    // Get the royalty information for the given Inscription
    let royaltyView = MetadataViews.getRoyalties(nft)!

    let externalURL = MetadataViews.getExternalURL(nft)!

    let collectionDisplay = MetadataViews.getInscriptionCollectionDisplay(nft)!
